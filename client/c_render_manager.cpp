...
double c_render_manager::get_render_posx() {
	...
	return java_instance->env->GetDoubleField(render_manager_cls, render_posx_field);
}
...
double c_render_manager::get_render_posy() {
	...
	return java_instance->env->GetDoubleField(render_manager_cls, render_posy_field);
}
...
double c_render_manager::get_render_posz() {
	...
	return java_instance->env->GetDoubleField(render_manager_cls, render_posz_field);
}